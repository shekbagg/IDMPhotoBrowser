...
- (void)updateToolbar {
	...
	if ([self numberOfPhotos] > 1) {
		_counterLabel.text = [NSString stringWithFormat:@"%lu %@ %lu", (unsigned long)(_currentPageIndex+1), @"of", (unsigned long)[self numberOfPhotos]];
	} else {
...
- (void)actionButtonPressed:(id)sender {
    ...
    if ([self numberOfPhotos] > 0 && [photo underlyingImage]) {
        ...
        else
        {
            ...
            self.actionsSheet.cancelButtonIndex = [self.actionsSheet addButtonWithTitle:@"Cancel"];
